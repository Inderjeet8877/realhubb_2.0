// src/admin/components/MultiImageUpload.tsx
// Supports uploading multiple images for a single property
// Displays as a grid with drag-to-reorder hint and remove buttons
...
interface MultiImageUploadProps {
  ...
  images:            string[];              // current list of URLs
